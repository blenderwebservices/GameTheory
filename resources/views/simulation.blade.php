<x-layouts.app>
    ...
    <div x-data="{
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="p-6 border border-gray-200 dark:border-gray-700 transition-colors duration-300"
                                        ...
                                        <div class="flex justify-center items-center gap-2 text-lg">
                                            <input type="number" x-model.number="matrix['AA'][0]" min="-10" max="10"
                                                step="1"
                                            ...
                                            <input type="number" x-model.number="matrix['AA'][1]" min="-10" max="10"
                                                step="1"
                                    ...
                                    <td class="p-6 border border-gray-200 dark:border-gray-700 transition-colors duration-300"
                                        ...
                                        <div class="flex justify-center items-center gap-2 text-lg">
                                            <input type="number" x-model.number="matrix['AB'][0]" min="-10" max="10"
                                                step="1"
                                                class="w-16 text-center font-bold text-blue-600 dark:text-blue-400 bg-transparent border-b border-blue-200 focus:border-blue-500 focus:outline-none"
                                                :class="{ 'underline': bestResponsesA.includes('AB') }">
                                            <span class="text-gray-400">,</span>
                                            <input type="number" x-model.number="matrix['AB'][1]" min="-10" max="10"
                                                step="1"
                                                class="w-16 text-center font-bold text-red-600 dark:text-red-400 bg-transparent border-b border-red-200 focus:border-red-500 focus:outline-none"
                                ...
                                <tr>
                                    ...
                                    <td class="p-6 border border-gray-200 dark:border-gray-700 transition-colors duration-300"
                                        ...
                                        <div class="flex justify-center items-center gap-2 text-lg">
                                            <input type="number" x-model.number="matrix['BA'][0]" min="-10" max="10"
                                                step="1"
                                                class="w-16 text-center font-bold text-blue-600 dark:text-blue-400 bg-transparent border-b border-blue-200 focus:border-blue-500 focus:outline-none"
                                                :class="{ 'underline': bestResponsesA.includes('BA') }">
                                            <span class="text-gray-400">,</span>
                                            <input type="number" x-model.number="matrix['BA'][1]" min="-10" max="10"
                                                step="1"
                                                class="w-16 text-center font-bold text-red-600 dark:text-red-400 bg-transparent border-b border-red-200 focus:border-red-500 focus:outline-none"
                                    ...
                                    <td class="p-6 border border-gray-200 dark:border-gray-700 transition-colors duration-300"
                                        ...
                                        <div class="flex justify-center items-center gap-2 text-lg">
                                            <input type="number" x-model.number="matrix['BB'][0]" min="-10" max="10"
                                                step="1"
                                                class="w-16 text-center font-bold text-blue-600 dark:text-blue-400 bg-transparent border-b border-blue-200 focus:border-blue-500 focus:outline-none"
                                                :class="{ 'underline': bestResponsesA.includes('BB') }">
                                            <span class="text-gray-400">,</span>
                                            <input type="number" x-model.number="matrix['BB'][1]" min="-10" max="10"
                                                step="1"
                                                class="w-16 text-center font-bold text-red-600 dark:text-red-400 bg-transparent border-b border-red-200 focus:border-red-500 focus:outline-none"
        ...
        <!-- Dominant Strategies Card -->
        <div x-show="dominantInfo.A || dominantInfo.B"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div x-show="dominantInfo.A"
                    ...
                    <h3 class="font-semibold text-blue-800 dark:text-blue-300 mb-2 flex items-center">
                        <span class="mr-2">{{ __('Player A') }} ({{ $gameScenario->player_a_name }}):</span>
                    </h3>
                ...
                <div x-show="dominantInfo.B"
                    ...
                    <h3 class="font-semibold text-red-800 dark:text-red-300 mb-2 flex items-center">
                        <span class="mr-2">{{ __('Player B') }} ({{ $gameScenario->player_b_name }}):</span>
                    </h3>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div class="space-y-4">
                    ...
                    <div
                        ...
                        <!-- Formula p -->
                        <div>
                            <p class="text-red-600 dark:text-red-400 font-bold mb-1">{{ __('p (Probability A Top):') }}
                            </p>
                            <p class="mb-1 text-gray-500">
